...
| `depth`                                  | Integer | 1       | Provide the level at which dependencies should be checked. Eg. if `moduleToCheck` = A/B/C/D/E and depth = 2 from back, then it will check for dependencies which are not of the form A/B/C/D/\*                                                                                                                                                     |
